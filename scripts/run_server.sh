...
function run_cohere() {
   ...
   ./build/bin/server -m $model -c 60000 -n 2048 --host 0.0.0.0 --port 9100 --n-gpu-layers 100 --chat-template command-r
}
...
function run_command_r_plus() {
   ...
   ./build/bin/server -m $model -c 100000 -n 2048 --host 0.0.0.0 --port 9100 --n-gpu-layers 200 --chat-template command-r
}
